 ...
 * @version 1.1.0
 * @variant FROZEN
 - 1.1.0 May 2024 add version info
 - (most of) The code in this class is from or based on
...
abstract class cartmart_234_abstract_module { // abstract class to replace phoenix hierarchy
  ...
  {
    return (defined(static::CONFIG_KEY_BASE . 'STATUS') && 'True' === constant(static::CONFIG_KEY_BASE . 'STATUS'));
  }
  ...
  public function __construct() {
    ...
    $this->title = !is_null(self::get_constant(static::CONFIG_KEY_BASE . 'TEXT_TITLE')) ? self::get_constant(static::CONFIG_KEY_BASE . 'TEXT_TITLE')
                : self::get_constant(static::CONFIG_KEY_BASE . 'TITLE');
    $this->description = is_null(self::get_constant(static::CONFIG_KEY_BASE . 'TEXT_DESCRIPTION')) ? self::get_constant(static::CONFIG_KEY_BASE . 'TEXT_DESCRIPTION')
    ...
    $this->sort_order = !is_null($this->base_constant('SORT_ORDER')) ? $this->base_constant('SORT_ORDER') : 0;
  }
